...
hist_data <- full_data %>% mutate(duration_ms = duration_ms/1000)
hist_gathered <- gather(full_data[,15:24], var, value)

max()
ggplot(hist_gathered, aes(value, fill = var)) + geom_histogram(bins = 50)
```
